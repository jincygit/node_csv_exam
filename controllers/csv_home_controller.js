...
module.exports.showFile = async function (req, res) {
    ...
    if(filePath){
        //header column filteration only for specific file
        if(filePath.fileName == "data.csv"){
            
            //STEAMING THE FILE
            //Specific Data Displayed: Only display the following data in the table: power, clock_speed, int_memory, mobile_wt.
            const expectedHeaders = ['power', 'clock_speed', 'int_memory', 'mobile_wt'];
